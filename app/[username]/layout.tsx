...
export async function generateMetadata({
  ...
  try {
    ...
    const { data: creatorData } = await fetch(`${appUrl}/api/creator/resolve/${encodeURIComponent(username)}`).then(res => res.json()).catch(() => ({ data: null }));
      ...
      if (post) {
        ...
        return {
          ...
          openGraph: {
            ...
            url: `${appUrl}/${username}?post=${postId}`,
            siteName: 'MeroCircle',
            type: 'article',
          },
          twitter: {
