  ...
  return (
    <div className="py-3 border-b border-border/15">
      <div className="flex gap-2 sm:gap-3 overflow-x-auto scrollbar-hide px-1 scroll-smooth-touch">
        ...
        >
          <div className="w-12 h-12 rounded-full border-2 border-dashed border-border/50 flex items-center justify-center bg-muted/20 hover:bg-muted/40 transition-colors">
