    ...
    <div className={cn(layout.flexBetween, 'py-4 border-b border-gray-200 dark:border-gray-700 last:border-b-0')}>
      <div className={cn(layout.flexRow, 'space-x-4 flex-1 min-w-0')}>
        <div onClick={handleCreatorClick} className="cursor-pointer">
          <Avatar className={cn(responsive.avatarSmall, 'hover:ring-2 hover:ring-blue-500 transition-all')}>
        ...
        <div className="flex-1 min-w-0">
          <p
            ...
            className={cn('font-medium', colors.text.primary, 'hover:text-blue-600 cursor-pointer transition-colors', typography.truncate)}
          >
            {creator.name}
          </p>
          {message && (
