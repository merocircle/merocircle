  ...
  const handleDeleteComment = useCallback(
    async (commentId: string) => {
      try {
        ...
        logger.error("Delete comment error", "ENHANCED_POST_CARD", {
          postId: post.id,
            ...
            <div className="px-4 sm:px-5 pt-4 sm:pt-5">
              ...
              >
                <Avatar className="h-9 w-9">
                  <AvatarImage
                    src={getValidAvatarUrl(creator.photo_url)}
            ...
            {(post.content || (shouldBlur && post.post_type !== "poll")) &&
              post.post_type !== "poll" && (
                <div
                  ...
                  onClick={
                    !shouldBlur ? handlePostClick : onNavigateToMembership
                  }
                >
                  {shouldBlur ? (
                  ...
                  {currentUserId ? (
                    ...
                    >
                      <Avatar className="h-8 w-8 shrink-0">
                        <AvatarImage
                          src={getValidAvatarUrl(currentUser?.photo_url)}
